/*
 * The code is copied from https://github.com/sxyu/volrend/blob/master/src/camera.cpp
 * in the PlenOctree viewer of [Yu et al. ICCV 2021]
 * with a small adaptation to this project.
 */
